...
def _setup(context, *args, **kwargs):
    ...
    wbc_share = Path(get_package_share_directory('arm_teleop_wbc_control'))
    ...
    base_params = wbc_share / 'config' / 'wbc_default.yaml'
    ...
    if base_source_override is not None:
        wbc_params['base_source'] = base_source_override

    nodes.append(Node(
        package='arm_teleop_wbc_control',
        executable='teleop_wbc',
        name='teleop_wbc',
        output='screen',
        parameters=[
            str(base_params),
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'teleop_config', default_value='teleop_wbc.yaml',
